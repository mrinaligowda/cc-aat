...
function deleteProduct(id){
    ...
    fetch("http://3.106.225.57:8000/products",{method:"DELETE",headers: {'Content-Type': 'application/json'},body: JSON.stringify(res)})
...
function initilize(){
    ...
    fetch("http://3.106.225.57:8000/products",{method:'GET'})
    .then(result=>result.json())
    .then((data)=>{
